...
import { faUsers, faComments, faLightbulb, faTools } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid gap-8 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div className="bg-stone-900 rounded-lg p-[50px] text-white text-center flex flex-col items-center">
            <FontAwesomeIcon icon={faUsers} className="text-yellow-500 text-2xl mb-2" />
            <h3 className="text-xl font-bold mb-2">MEET</h3>
            <p className="text-sm">
              Sed ut perspiciatis unde omnis iste natus error sit voluptatem accuntium.
            </p>
          </div>
          <div className="bg-stone-900 rounded-lg p-[50px] text-white text-center flex flex-col items-center">
            <FontAwesomeIcon icon={faComments} className="text-yellow-500 text-2xl mb-2" />
          ...
          <div className="bg-stone-900 rounded-lg p-[50px] text-white text-center flex flex-col items-center">
            <FontAwesomeIcon icon={faTools} className="text-yellow-500 text-2xl mb-2" />
